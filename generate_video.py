#!/usr/bin/env python3
"""
Updated generate_video.py: default codec set to libx265 (HEVC lossless), improved visuals (additional dynamics, contrast/gamma),
retained plasma colormap, and added safe defaults. Falls back to grayscale if matplotlib missing.
"""
...
def evolve_step(grid, noise_amp, t, global_mod):
    ...
    # Coherent sinusoidal modulation for motion and texture
    h, w = grid.shape
